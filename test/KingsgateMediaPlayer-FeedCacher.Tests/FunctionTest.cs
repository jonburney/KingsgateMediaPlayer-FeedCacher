...
using KingsgateMediaPlayerFeedCacher;

namespace KingsgateMediaPlayerFeedCacher.Tests
{
    public class FunctionTest
    {
        ...
        public async Task TestS3EventLambdaFunction()
        {
            ...
            var bucketName = "lambda-KingsgateMediaPlayerFeedCacher-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
